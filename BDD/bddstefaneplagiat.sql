...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mer. 18 avr. 2018 à 20:33
...
(1, '27 rue de Lachelite', 215, 'oui', 10, 800000, 'Flours', 1, 'Maison d\'architecte originale', 'Maison plein pied - 10 pièces - 215m²', 'pictures/imageSlider/slidermaison/slidermaison1/image1maison1.jpg'),
(2, '43 rue de Lichnerre', 128, 'oui', 8, 148240, 'Flers', 1, 'Maison à vendre Flers', 'Maison deux étages - 8 pièces - 128m²', 'pictures/imageSlider/slidermaison/slidermaison2/image1maison2.jpg'),
(3, '38 rue du Tapis', 118, 'oui', 6, 415360, 'Audierne', 1, 'Maison à vendre Audierne', 'Maison deux étages et cave - 6 pièces - 118m²', 'pictures/imageSlider/slidermaison/slidermaison3/image1maison3.jpg'),
(4, '17 rue des Pommiers', 157, 'oui', 9, 352820, 'Bignou', 1, 'Maison à vendre Bignou', 'Maison deux étages avec grenier - 9 pièces - 157m²', 'pictures/imageSlider/slidermaison/slidermaison4/image1maison4.jpg'),
(5, '52 rue Cocinelle', 146, 'non', 8, 353600, 'Pornichet', 1, 'Maison à vendre Pornichet', 'Maison deux étages - 8 pièces - 146m²', 'pictures/imageSlider/slidermaison/slidermaison5/image1maison5.jpg'),
(6, '5 rue Lavoisier', 45, 'non', 2, 156000, 'Leers', 2, 'Appartement Leers', 'Appartement 2 Pièces 44,83 m2', 'pictures/imageSlider/sliderappart/sliderappart1/appart1photo2.jpg'),
(7, '12 rue Poitije', 40, 'non', 2, 156000, 'Saint-Maurice', 2, 'Appartement Saint-Maur-Des-Fosses', 'Vente appartement 2 pièces 40 m² Saint-Maur-Des-Fosses (94)', 'pictures/imageSlider/sliderappart/sliderappart2/appart2photo2.jpg'),
(8, '19 rue Patate', 51, 'non', 3, 165000, 'Nice', 2, 'Appartement Saint-Maur-Des-Fosses', 'Vente appartement 3 pièces 51 m² Nice', 'pictures/imageSlider/sliderappart/sliderappart3/appart3photo2.jpg'),
(9, '11 rue Loupite', 50, 'non', 2, 265000, 'Levallois', 2, 'Appartement Levallois-Perret', 'Vente appartement 2 pièces 50 m² Levallois-Perret (92300)', 'pictures/imageSlider/sliderappart/sliderappart4/appartement4.jpg'),
(10, '95 rue Maurice', 36, 'non', 2, 250000, 'Paris', 2, 'Appartement à Paris', 'charmant loft de 2 pièces au dernier étage avec ascenseur 36m²', 'pictures/imageSlider/sliderappart/sliderappart5/appart5photo2.jpg'),
(11, '52 rue de la Balade', 32, 'non', 2, 260000, 'Galande', 2, 'Appartement à Galande', 'Appartement T1 Bis de 31,55 m² LC non meublé situé au 4ème étage d\'un immeuble sécurisé de 1600', 'pictures/imageSlider/sliderappart/sliderappart6/appart6photo2.jpeg'),
(12, '27 rue Hospote', 36, 'non', 2, 165000, 'Muette', 2, 'Appartement à Muette', 'charmant loft de 2 pièces au dernier étage avec ascenseur 36m²', 'pictures/imageSlider/sliderappart/sliderappart7/appart7photo2.jpg'),
(13, '14 rue Klagoun', 162, 'non', 32, 752000, 'Lille', 3, 'Local LE SEDAF', ' local a louer - 162m² - 310€/m²/an', 'pictures/imageSlider/sliderlocaux/sliderlocal1/image1local1.jpg'),
(14, '23 rue Jaures', 400, 'non', 8, 950000, 'Roubaix', 3, 'Local Show Room type loft', 'local a louer - 400m² - 600€/m²/an', 'pictures/imageSlider/sliderlocaux/sliderlocal2/image1local2.jpg'),
(15, '26 rue Louvre', 90, 'oui', 9, 854200, 'Marseille', 3, 'Local Galerie d’Art au Cœur de Saint Germain', ' local a louer - 90m² - 1000€/m²/an', 'pictures/imageSlider/sliderlocaux/sliderlocal3/image1local3.jpg'),
(16, '27 rue Mer', 848, 'non', 80, 1400000, 'Bourget', 4, 'Vente immeuble Le Bourget (93350)', '10 appartements, 5 garages dans 2 immeubles sur terrain 848 m²', 'pictures/imageSlider/sliderimmeuble/sliderimmeuble1/image1immeuble1.jpg'),
(17, '42 rue Pavis', 820, 'non', 59, 990000, 'Luxe', 4, 'Vente immeuble Portugal', 'Residence de Luxe 820m²', 'pictures/imageSlider/sliderimmeuble/sliderimmeuble2/image1immeuble2.jpg'),
(18, '46 rue Lavoisier', 150, 'oui', 0, 80000, 'Bloup', 5, 'Terrain 500m² Boisemont', ' terrain 500 m² Boisemont (95000)', 'pictures/imageSlider/sliderterrain/sliderterrain1/image1terrain1.jpg'),
(19, '57 rue Loupille', 1000, 'oui', 0, 150000, 'Basses', 5, 'Terrain 1.000 m² Basses', 'Vente terrain 1.000 m² Basses (86200)', 'pictures/imageSlider/sliderterrain/sliderterrain2/image1terrain2.jpg'),
(20, '62 rue Belleverte', 750, 'oui', 0, 85000, 'Bignou', 5, 'Terrain 750m²', 'Vente terrain 750m² Bignou', 'pictures/imageSlider/sliderterrain/sliderterrain3/image1terrain3.jpg'),
(21, '75 rue Lafoison', 686, 'oui', 0, 152258, 'Iledyeu', 5, 'Terrain 686 m²', 'terrain 686 m² L\'ile-D\'yeu (85350)', 'pictures/imageSlider/sliderterrain/sliderterrain4/image1terrain4.jpg');
