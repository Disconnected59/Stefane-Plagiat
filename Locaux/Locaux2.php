...
<html xmins="http://www.w3.org/1999.xhtml" xml:lang="fr" lang="fr">
    ...
    <h1> Local Show Room type loft </h1>
		<div class="slider">
          <input type="radio" name="slide_switch" id="id1"/>
          <label for="id1">
            <img src="../pictures/imageSlider/sliderlocaux/sliderlocal2/image1local2.jpg" width="100"/>
          </label>
          <img src="../pictures/imageSlider/sliderlocaux/sliderlocal2/image1local2.jpg"/>
          
          <input type="radio" name="slide_switch" id="id2" checked="checked"/>
          <label for="id2">
            <img src="../pictures/imageSlider/sliderlocaux/sliderlocal2/image2local2.jpg" width="100"/>
          </label>
          <img src="../pictures/imageSlider/sliderlocaux/sliderlocal2/image2local2.jpg"/>
          
          <input type="radio" name="slide_switch" id="id3"/>
          <label for="id3">
            <img src="../pictures/imageSlider/sliderlocaux/sliderlocal2/image3local2.jpg" width="100"/>
          </label>
          <img src="../pictures/imageSlider/sliderlocaux/sliderlocal2/image3local2.jpg"/>
